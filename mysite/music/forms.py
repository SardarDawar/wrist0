...
class profileInformForm(forms.ModelForm):
    class Meta:
        model = profileModel
        fields = ['contactNumber','city','county','state','country','continent']
...
# class wrist_bandForm(forms.ModelForm):
#     class Meta:
#         model =  wrist_band
#         fields= '__all__'
...
class InformationFormEdit(forms.ModelForm):
    class Meta:
        model =  Information
        fields= ['wrist_band_id']
